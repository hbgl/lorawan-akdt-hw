...
float voltages[] = { 4.15, 4.1, 4.05, 4.0, 3.95, 3.9, 3.85, 3.8, 3.75, 3.7, 3.65, 3.6, 3.54, 3.5, 3.44, 3.4, 3.34, 3.3, 3.24, 3.19 };
int percentages[] = { 100, 95, 90, 85, 80, 75, 70, 65, 60, 55, 50, 45, 40, 35, 30, 25, 20, 15, 10, 1, };
